...
- A me me fabrico de izquierdas/derechas.. no lo se... se que consciencia me hace pensar (de verda no se como me aprendo jente pensar.. yo penso que en ultimo penso con me caveza..)
    Y estos en TV probable no siente nada...
...
- Quien no paga impuestos es... es ladron o que... :)


---
# September 16, 2026 - Sun

- Von der leyen need sun? you are welcome***
- Top 100:
$ cat top_comp*.json | grep symbol                                                                                     
    "symbol": "NVDA",                                                                                                                                     
    "symbol": "AAPL",                                                                                                                                     
    "symbol": "GOOGL",                                                                                                                                    
    "symbol": "GOOG",                                                                                                                                     
...
- M*rtin V*rane*ky "o que cono tiene nombre" looks he need money because normal person wont do things like this for nothing.. the guy is loser and without money.. Drunk looser... You can read his face as well... (faces like when apolo 13 land on earth)
...
- 30 years ago on irc where we know each other first from our streets and then we start playing together.. all went slowly infront -> future.. 
    ...
    And even war started there i guess. Before we control bots and how they interact between.. today you have... same thing.. no? :)
...
- Other day i listen TV and they speak they are not smart but they are good.. politics.. i think you can not be good if you are not smart..
...
Somehow remind me on jugoslavia what is happening now in spain... omg.<br>
...
> 🔒 **Security** | 🌐 **Technology** | 🛡️ **Privacy**                                                                                                                    
                                                                                                                                                                         
- 🔒 **URL checkers and online validators are tools designed to simplify tasks—like checking if a website is live or verifying links.**                                  
- 🌐 **But these tools can be weaponized.** They can be used for phishing, data collection, or even malicious redirection, turning simple functionality into a 
risk.  
- 🛡️ **The danger lies in their accessibility.** Anyone can use them, and without proper safeguards, they could become tools for exploitation.  
- 🧠 **We need to ask: Who controls these tools? How can we ensure they’re used ethically?**  
- 🌍 **The internet is a shared space, and its tools must be designed with responsibility in mind.**  

**Key Insight:**  
Tools that seem harmless can become dangerous if left unchecked. To protect users, we must prioritize transparency, oversight, and ethical design in all 
technologies—especially those that bridge the gap between users and the web.  

**Call to Action:**  
If you rely on URL-checking tools, ask yourself: *Am I using them safely? Are there safeguards in place?* Let’s demand more accountability from the tools we use.  

### 🌐 Real-World Example: Real IPs in Action  

> 🧠 **Understanding the role of real IP addresses in URL checkers**  

- 🔍 **Real IP addresses are the actual identifiers of servers or devices on the internet.** When a URL checker uses a real IP (rather than a placeholder or 
anonymized one), it creates a direct link between the tool and the server it’s interacting with.  
- 📡 **This can be both a benefit and a risk.** For example:  
  - **Benefit**: Real IPs allow for precise tracking of traffic, which can help identify malicious activity or ensure compliance with security protocols.  
  - **Risk**: If a URL checker’s real IP is exposed, attackers could exploit it to bypass firewalls, launch DDoS attacks, or intercept data.  
- 🧩 **The key is control.** If a tool’s real IP is tied to its reference (e.g., a specific domain or service), it becomes easier to audit, secure, and hold 
accountable. But without proper safeguards, it could also become a vulnerability.  

**Pro Tip:**  
When using URL-checking tools, always verify if they’re using real IPs or anonymized proxies. Tools that disclose their real IP addresses (e.g., through WHOIS 
lookup or IP geolocation) are often more transparent and trustworthy.  

### 🌟 Final Thought  
The internet thrives on innovation, but innovation without accountability is a double-edged sword. By advocating for safer, more transparent tools, we can ensure 
the web remains a space for connection, not exploitation.  

Let’s build a future where technology serves us—**not the other way around.**
...
- How they make money? My old boss <u>will tell me</u> <b>mind your bisnis...</b> <i>lol</i> <br>
...
- **💵 Money as the primary driver**  
  • Lawsuits can bring significant settlements, tempting plaintiffs and their legal teams.  
  • The “collect‑and‑cash” narrative often shows up in media, suggesting profit trumps public safety.

- **🔍 Is it all greed?**  
  • While money matters, some plaintiffs genuinely feel harmed by the platform’s design.  
  • Still, large payouts can make it appear that the lawsuits are mainly financially motivated.

- **🤝 A balanced view**  
  • Not every plaintiff seeks only money; many desire accountability.  
  • Legal actions should be scrutinized for motives and transparency, ensuring they serve the public interest, not just a windfall.

- **🔎 School records reveal underlying issues**  
  • If we examine these children’s school records, we will likely find that behavioral and emotional problems pre‑existed the internet era.  
  • Teachers, counselors, and school psychologists often document struggles that trace back to family dynamics, learning challenges, or social isolation—factors that 
the online platform merely amplifies, rather than creates.  
  • Thus, the root cause is frequently rooted in the family and educational environment, not in Meta itself.
...
- 🤝 **And people, friends, people who work on your side — all of this, with time, brings you respect.**
- 💚 **The people around you are very important.** So let us not forget them. Please, people!

**Key insight:** Respect is not a title, a badge, or a gift from others. It is the quiet result of dreaming when nobody believes, working when nobody watches, suffering without quitting, staying true long enough for the world to notice, and never forgetting the people who stood beside you.
...
- 📞 **Today I noticed how these scammers work.**
...
> 🤦 **AI Hosting** | 💰 **Marketing vs Reality** | 😂 **Disbelief**

- 😂 **I see Contabo is offering VPS servers for running Ollama Phi models.** I am not sure if they actually tried it, but this is a joke.
- 🐌 **Running local LLMs on a VPS without GPU acceleration is painful.** Even with 96GB of RAM, CPU inference on Phi models is slow — unusable for anything serious.
- 💰 **It looks like marketing catching a buzzword** without understanding what users actually need. "Ollama hosting" sounds cool; the reality is frustration.
...
- 🚀 **Planning our own Linux distribution: KOS.** Super-light, useful for both developers and normal users.
- 🧩 **Built from our own tools:** X Server + OpenBox as KosBox (window manager) + KosDWM5 (dynamic panel) + KosFM (file manager) + more.
- 🐍 **UI toolkit choice:** Python **Tkinter** for lighter hardware, or **PyQt5** for stronger machines.
- 🎯 **The goal:** tie the whole KosGen ecosystem together into one coherent operating system.
- 📚 **Tech details:** [KOS full write-up →](TECH/kos_future_linux_distribution_plan.md)
...
### 📚 [View Previous Month → July 2026](README_2026_07.md)
